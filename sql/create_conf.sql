...
INSERT INTO props (
    ...
    ('property_type', 'set', NULL, 'string', NULL, NULL, NULL, 1),
    ('property_type', 'set', NULL, 'integer', NULL, NULL, NULL, 1),
    ('property_type', 'set', NULL, 'double', NULL, NULL, NULL, 1),
    ('property_type', 'set', NULL, 'date', NULL, NULL, NULL, 1),
    ('property_type', 'set', NULL, 'datetime', NULL, NULL, NULL, 1),
    ('property_type', 'set', NULL, 'boolean', NULL, NULL, NULL, 1),
    ('property_type', 'set', NULL, 'set', NULL, NULL, NULL, 1),
    ('property_type', 'set', NULL, 'reference', NULL, NULL, NULL, 1),
    ('property_type', 'set', NULL, 'file', NULL, NULL, NULL, 1),
