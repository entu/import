...
INSERT INTO props (
    ...
    ('property_ordinal', 'ordinal', 'integer', NULL, 4, NULL),
    ...
    ('property_list', 'ordinal', 'integer', NULL, 5, NULL),
    ...
    ('property_multilingual', 'ordinal', 'integer', NULL, 6, NULL),
    ...
    ('property_public', 'ordinal', 'integer', NULL, 7, NULL),
    ...
    ('property_classifier', 'ordinal', 'integer', NULL, 8, NULL),
